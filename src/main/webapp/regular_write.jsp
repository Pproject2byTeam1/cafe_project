...
<body>
	...
	<main id="main" class="main">
		...
		<form name="bbs" action="board_datacontentright.do" method="POST"
			enctype="multipart/form-data">
			<table width="95%" border="2" align="center" id="ta_in"></table>
				...
				<div class="container-fluid">
					...
					<div class="row pt-4">
						<div class="col-md-1"></div>
							<div class="col-md-10 text-lg-end" style="float:right;">
				...
				<footer id="footer" class="footer">
					<div class="copyright">
						&copy; Copyright <strong><span>NiceAdmin</span></strong>. All
						Rights Reserved
					</div>
					<div class="credits">
