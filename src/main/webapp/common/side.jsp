	...
	<div class="pagetitle">
      ...
      <nav>
        <div class="card-body">
          ...
          <a class="card-title"><span>글 14개 | 댓글 160개 | 쪽지 5개</span></a><br>
          <a class="card-title">활동내역 <span>| POINT</span></a><br>
          <a class="card-title">나의 정보 <span>| COUNT</span></a><br>
          <a class="card-title">로그아웃 <span>| COUNT</span></a><br>
		  <a class="card-title">가입하기 <span>| (비회훤활성)</span></a><br>
      </nav>
     </div>
	</div>
	<!-- 프로필 끝 -->
