				...
				<div class="col-md-10">
					<div class="card">
						<div class="card-body ms-5">
							<h3 class="card-title">정모하는 날(제목)</h3>
							<div>&emsp;&emsp;&emsp;시작일 &emsp; &emsp; &emsp; &emsp; &emsp;
						&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;종료일</div>
							...
							<form class="row g-3">
								...
								<hr>
								<div class="col-10 ">
									<div class="form-floating ps-5">
									&nbsp;&nbsp;
										<textarea class="form-control" placeholder="내용"
										
											id="floatingTextarea" style="height: 100px;"></textarea>
										<div align="right">참석자 : 홍길동/ 이순신</div>
									</div>
								</div>
								<hr>
								<div class="col-lg-12">
									<div class="card">
										<div class="card-body row">
											...
											<hr><br />
											<div>
												<div class="ps-5 ms-5 form-floating col-lg-10 row">
													<div class="col-10">
														<textarea class="form-control" placeholder="답글을 작성해주세요"
										...
										<div class="card-body row">
											<div class="col-sm-2">
												<table>
													<tr>
														<td><img src="./image/rank_icon/1.gif"></img></td>
