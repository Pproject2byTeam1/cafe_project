			...
			<div class="col-lg-12">
				<div class="maincard">
					<div class="row">
						...
						<div class="col-md-7">
							<div class="row">
							 <label for="form-control" class="col">아이콘 : <input type="file" name="cafe_icon" value="${cafebanner.cafe_icon}" class="form-control" placeholder="카페 아이콘" accept="image/*" id="getfile" onchange="seticon(event)" required></label>
