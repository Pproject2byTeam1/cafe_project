	...
	<main id="main" class="main">
			...
			<nav>
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item"><a
						href="databoard_list.do?b_code=${b_code}">게시판이름</a></li>
		...
		<div class="container">
			<div class="row">
				...
				<form name="bbs" action="replyWriteDataBoard.do" method="POST" enctype="multipart/form-data">
					<div class="col-10">
							...
							<div class="park-card-body row">
								<div class="mb-3 row">
									...
									<div class="col-8">
										...
										<input id="reply_idx" name="reply_idx" value="${idx}" type="hidden" />
