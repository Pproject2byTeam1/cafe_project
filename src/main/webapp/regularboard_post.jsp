						...
						<div class="marketcard">
							<div class="marketcard-body">
								...
								<div class="row">
									...
									<div class="col-md-12">
										<div class="col-md-12">
											<h1 id="marketB_Title">솔직히 한국축구 거품이라고 생각하지 않냐?</h1><br>
										</div>
										...
										<table>
											<tr>
												...
												<td><h6 class="card-title">닉네임</h5></td>
												<td></td>
													<td><h6 class="card-title">작성일자</h5></td>
											</tr>
										</table> -->
										<div class="col-md-12">
											<div class="row">
												<div class="col-md-5">
													<p class="card-text"><img src="./image/rank_icon/1.gif">혜화역축잘알박주영</p>
												</div>
												<div class="col-md-2">
													<p class="text-right card-text">조회수:10</p>
												</div>
												<div class="col-md-2">
													<p class="text-right card-text">추천:10</p>
												</div>
												<div class="col-md-3">
													<p class="text-right card-text">작성일자: 2022-11-24</p>
												</div>
											</div>
										</div>
									...
									<hr>
										<div class="row">
											<div class="col-lg-12">
												...
												<text class="form-control" style="height: 500px" readonly> 언블리'버블'</textarea>
