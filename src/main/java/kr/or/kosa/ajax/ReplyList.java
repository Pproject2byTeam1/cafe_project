	    					...
	    					out.print("<div class='row'>");
	    						out.print("<div class='col'>");
	    							...
	    							out.print("<ul class=\"dropdown-menu dropdown-menu-end dropdown-menu-arrow\">\r\n"
	    									+ "		<li class=\"anw_memo\"><a class=\"dropdown-item sendToMemo\" href=\"write_memo.do?sender_id="+reply.getEmail_id()+"\" >답장 보내기</a></li>\r\n"
	    									+ "		<li class=\"view_user_activity\"><a class=\"dropdown-item viewActivity\" href=\"user_activity.do?email_id="+reply.getEmail_id()+"\" >활동 내역 보기</a></li>\r\n"
	    									+ "	</ul>");
	    						out.print("</div>");
